...
<body>
    ...
    <nav class="navbar navbar-expand p-0">
        <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="{{ route('home') }}"> SDIT AR-RISALAH </a>
...
mb-4" type="text" placeholder="Search" aria-label="Search" /> -->
                    ...
                    <li>
                        <a href="{{route('levels.index')}}">
                            <span class="oi oi-badge"></span>Tingkat
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('school-years.index')}}">
                            <span class="oi oi-flag"></span>Tahun
                        </a>
                    </li>
                    <li>
